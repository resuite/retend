...
- `topLayer` (boolean, optional) — Place children in the browser top layer during transitions.
- `onStart` (() => void, optional) — Called once when a transition starts.
- `onEnd` (() => void, optional) — Called once when a transition ends.
