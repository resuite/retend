---
title: 'Page Metadata'
description: 'Define page titles, meta tags, and Open Graph tags per route.'
---

# Page Metadata

Retend's router has built-in support for managing page metadata — titles, descriptions, Open Graph tags, Twitter cards, and more. Metadata is defined per-route and updates automatically when the user navigates. With SSR or SSG, those tags are also written into the initial HTML head.
