...
description: 'Get started with your first Retend project.'
---
...
> All new Retend projects come with DevTools pre-installed. Look for the floating "RT" button in the corner of your screen to inspect your component tree and live state.
...
- **[JSX and Components](/docs/jsx-and-components)**: Build reusable pieces for your user interface.
- **[Reactivity and Cells](/docs/reactivity-and-cells)**: Learn deeply how reactive state works.
- **[Control Flow](/docs/control-flow)**: Handle lists and conditional logic.
- **[DevTools](/docs/devtools)**: Learn how to use the built-in inspector.
