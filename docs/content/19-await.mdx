...
_(Note: Unlike `If`, `For`, and `Switch` which are called as functions, `Await` is used as a JSX component with props because it wraps a section of your layout rather than producing a single value.)_
