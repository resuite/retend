...
## Working with the DOM using `onConnected`

Sometimes you need to interact directly with an HTML element—for example, to measure its size, draw on a canvas, or attach a third-party library.
