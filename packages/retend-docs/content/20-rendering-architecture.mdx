...
If you ever look closely at Retend's core code, you might notice something interesting: it doesn't actually know anything about HTML or the browser's Document Object Model (DOM).
