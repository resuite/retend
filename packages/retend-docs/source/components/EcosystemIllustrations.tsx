  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="36"
        rx="8"
        class="fill-surface stroke-border/50 dark:stroke-border/30"
        stroke-width="2.5"
      />
      <circle
        cx="80"
        cy="33"
        r="5"
        class="fill-fg-muted/10 stroke-border/50"
        stroke-width="1.5"
      />
      <circle
        cx="96"
      ...
      <rect
        ...
        height="14"
        rx="4"
        class="fill-surface-alt/50 stroke-border/50"
        stroke-width="1.5"
      />
      <rect
        x="140"
      ...
      <rect
        ...
        height="45"
        rx="6"
        class="fill-surface-alt/30 stroke-border/30"
        stroke-width="2"
      />
      <rect
        x="95"
      ...
      <rect
        ...
        height="4"
        rx="2"
        class="fill-fg-muted/5"
      />

      {/* Center Branch (active) */}
      <path
        d="M 200 90 L 200 115"
        class="stroke-fg-muted/30"
        stroke-width="2.5"
      />
      ...
      <rect
        ...
        height="25"
        rx="3"
        class="fill-surface stroke-border/40"
        stroke-width="1.5"
      />
      <rect
        x="183"
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="100"
        rx="4"
        class="fill-surface-alt/40 stroke-border/40"
        stroke-width="2"
      />
      <rect
        x="85"
      ...
      <g class="translate-x-[230px] translate-y-[40px]">
        <rect
          ...
          height="120"
          rx="4"
          class="fill-surface stroke-border/40 shadow-sm"
          stroke-width="2"
        />
        <rect
          x="15"
        ...
        <rect
          ...
          height="40"
          rx="2"
          class="fill-surface-alt/40 stroke-border/30"
          stroke-width="1.5"
        />
        <rect
          x="15"
    ...
    >
      ...
      <g class="translate-x-[100px] translate-y-[60px]">
        <circle
          ...
          cy="20"
          r="15"
          class="fill-surface-alt/30 stroke-border/20"
          stroke-width="1.5"
        />
        <rect
          x="45"
      ...
      <g class="translate-x-[215px] translate-y-[60px]">
        <circle
          ...
          cy="20"
          r="15"
          class="fill-surface-alt/50 stroke-border/30"
          stroke-width="2"
        />
        <rect
          x="45"
      ...
      <rect
        ...
        height="140"
        rx="5"
        class="fill-fg-muted/20 stroke-border/30"
        stroke-width="2"
      />
    </svg>
  );
    ...
    >
      ...
      <g class="translate-x-[90px] translate-y-[75px]">
        ...
        <rect
          ...
          height="70"
          rx="8"
          class="fill-fg-muted/5 stroke-border/10"
          stroke-width="1"
        />
        ...
        <rect
          ...
          height="70"
          rx="8"
          class="fill-surface-alt/30 stroke-fg-muted/30 shadow-sm"
          stroke-width="2.5"
        />
        <rect
          x="15"
      ...
      <path
        d="M 280 15 L 240 100 L 270 100 L 220 185"
        class="stroke-fg-muted/20"
        stroke-width="6"
      ...
      <path
        d="M 280 15 L 240 100 L 270 100 L 220 185"
        class="stroke-surface dark:stroke-surface"
        stroke-width="2.5"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      ...
      <g class="translate-x-[305px] translate-y-[85px]">
        <circle
          ...
          cy="0"
          r="22"
          class="fill-fg-muted/10 stroke-border/20"
          stroke-width="1"
        />
        <text
          x="0"
          y="4"
          class="fill-fg-muted/40 text-[10px] font-bold"
          text-anchor="middle"
        >
          0ms
        </text>
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="160"
        rx="12"
        class="fill-fg-muted/5 stroke-border/30"
        stroke-width="2.5"
        stroke-dasharray="8 4"
      />
      ...
      <circle
        ...
        cy="50"
        r="12"
        class="fill-fg-muted/30 stroke-border/40"
        stroke-width="2.5"
      />
      ...
      <rect
        ...
        height="90"
        rx="8"
        class="fill-surface stroke-border/30"
        stroke-width="2"
        stroke-dasharray="6 3"
      />
      <circle
      ...
      />
      <path
        d="M 133 107 L 115 130"
        class="stroke-border/20"
        stroke-width="1.5"
      />
      <path
        d="M 147 107 L 165 130"
        class="stroke-border/20"
        stroke-width="1.5"
      />
      <circle
      ...
      />
      <path
        d="M 253 107 L 240 130"
        class="stroke-border/20"
        stroke-width="1.5"
      />
      <path
        d="M 267 107 L 280 130"
        class="stroke-border/20"
        stroke-width="1.5"
      />
      <circle
        ...
        cy="140"
        r="7"
        class="fill-fg-muted/20 stroke-border/20"
        stroke-width="1.5"
      />
      <circle
        cx="280"
...
export function UniversalRenderingIllustration() {
  return (
    ...
    >
      ...
      />
      <path
        d="M 152 158 L 154 160 L 159 155"
        class="stroke-fg-muted/40"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      ...
      />
      <path
        d="M 152 175 L 154 177 L 159 172"
        class="stroke-fg-muted/40"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
